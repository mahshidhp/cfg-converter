        ...
        <div className="row">
          <div className="col-sm-12 card-shadow">
            <div className="text-start light-text">
              ...
              <hr />
              <p>
                This website is a tool that converts input context-free grammar
                to different normal forms. Currently, we support following
                forms: <br />
              </p>
              <ul>
                <li>
              ...
              <p>
                Before conversion, the grammar gets simplified and redundant
                rules (such as null and unit productions) are deleted.
              </p>
              <h5>Resources:</h5>
              <ul>
                <li>
